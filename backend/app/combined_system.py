...
print("Combined Face Recognition + Emotion Detection Started")
...
while True:
            ...
            if time.time() - last_recognition_time > recognition_interval and face_img.size != 0:
                try:
                    ...
                    if len(result) > 0 and len(result[0]) > 0:
                        ...
                        current_name = os.path.basename(os.path.dirname(matched_path))
                    else:
                        current_name = "Unknown"
    ...
    cv2.imshow("Combined AI Face Emotion System", frame)
